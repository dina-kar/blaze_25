  ...
  return (
    <div className="relative w-full overflow-hidden bg-[#030303]">
      ...
      <div className="relative min-h-screen w-full flex items-center justify-center">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-500/[0.1] via-transparent to-violet-500/[0.1] blur-3xl" />
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
              <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                ...
                <span
                  className={cn(
                    "bg-clip-text text-transparent bg-gradient-to-r from-purple-300 via-white/90 to-violet-300 ",
                    pacifico.className,
                  )}
                >
                  {title2}
            ...
            <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
              <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                Join us for the most electrifying college festival of the year. Experience competitions, workshops,
      ...
      {/* Events Section (separated from hero) */}
      <div className="relative bg-[#030303] z-10">
        <EventsSection />
      </div>
    </div>
  )
